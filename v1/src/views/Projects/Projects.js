      ...
      <div className="work-grid" id="gridStart">
        <div className="work1" id="0">
          <Card
            ...
            css={ light ? "linear-gradient(to top, #a8edea 0%, #fed6e3 100%)" : "linear-gradient(to top, rgb(27, 138, 133) 0%, rgb(218, 101, 139) 100%)"} // linear-gradient(to top, rgb(27, 138, 133) 0%, rgb(218, 101, 139) 100%);
            active={active[0]}
            link="https://rl-inc.io/"
          >
            <img src={rl} alt="rl" style={{...imageStyles, maxWidth: '50%'}} />
          </Card>
        </div>
        <div className="work2" id="1">
          <Card
            ...
            css={light ? "linear-gradient(-20deg, #ddd6f3 0%, #faaca8 100%, #faaca8 100%)" : "linear-gradient(-20deg, rgb(171 156 216) 0%, rgb(189 96 91) 100%, rgb(191 132 129) 100%)"} //linear-gradient(-20deg, rgb(171 156 216) 0%, rgb(189 96 91) 100%, rgb(191 132 129) 100%);
            active={active[1]}
        ...
        <div className="work3" id="2">
          <Card
            ...
            css={ light ? "linear-gradient(to top, #d299c2 0%, #fef9d7 100%)" : "linear-gradient(to top, rgb(189 93 162) 0%, rgb(222 214 155) 100%)"} //linear-gradient(to top, rgb(189 93 162) 0%, rgb(222 214 155) 100%)
            active={active[2]}
        ...
        <div className="work4" id="3">
          <Card
            ...
            css={light ? "linear-gradient(120deg, #e0c3fc 0%, #8ec5fc 100%)" : "linear-gradient(120deg, rgb(204 151 255) 0%, rgb(87 144 202) 100%)"} // linear-gradient(120deg, rgb(204 151 255) 0%, rgb(87 144 202) 100%)
            active={active[3]}
        ...
        <div className="work5" id="4">
          <Card
            ...
            css={light ? "linear-gradient(120deg, #f093fb 0%, #f5576c 100%)" : "linear-gradient(120deg, rgb(213 85 228) 0%, rgb(177 66 80) 100%)"}//linear-gradient(120deg, rgb(213 85 228) 0%, rgb(177 66 80) 100%)
            active={active[4]}
        ...
        <div className="work6" id="5">
          <Card
            ...
            css={light ? "linear-gradient(to top, #ebc0fd 0%, #d9ded8 100%)" : "linear-gradient(to top, rgb(174 101 204) 0%, rgb(173 214 165) 100%)"} //linear-gradient(to top, rgb(174 101 204) 0%, rgb(173 214 165) 100%)
            active={active[5]}
